...
def create_data_for_vae(all_params_dict, dataset_name, path_to_save, save=False, preloaded_recs_dict=None):
    ...
    balance_train = all_params_dict['sounds_metadata']['balance_train']
